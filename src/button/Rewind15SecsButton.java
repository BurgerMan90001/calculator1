...
public class Rewind15SecsButton extends JButton {
    ...
    public Rewind15SecsButton(){
        setBounds(155, 470, 40,40);
        setBorder(null);
        ...
        ImageIcon Skip = new ImageIcon("ButtonIcons/rewind15Seconds.png");
        setIcon(Skip);
